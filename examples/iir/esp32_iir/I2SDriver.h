...
public:
  ...
  esp_err_t setup(uint32_t _sample_rate = 8000, uint32_t _buffer_size = 8, uint8_t _channel_count = 2, i2s_bits_per_sample_t _bits_per_sample = I2S_BITS_PER_SAMPLE_32BIT, i2s_channel_fmt_t _channel_fmt = I2S_CHANNEL_FMT_RIGHT_LEFT);
  void close(void);
