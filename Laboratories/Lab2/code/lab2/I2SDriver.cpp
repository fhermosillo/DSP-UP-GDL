...
I2SDriver::I2SDriver(i2s_port_t _i2s_port, uint8_t _bclk_pin, uint8_t _lrck_pin, int8_t _dout_pin, int8_t _din_pin, int8_t _mck_pin) {
  ...
  // I2S pinout
  i2s_pinout.bck_io_num = _bclk_pin;    // Bit clock
  i2s_pinout.ws_io_num = _lrck_pin;     // Word selection
  i2s_pinout.data_out_num = _dout_pin;  // Data output
  i2s_pinout.data_in_num = _din_pin;    // Data input
  i2s_pinout.mck_io_num = _mck_pin;     // Master clock
